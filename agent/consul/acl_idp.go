...
type IdentityProviderFunc func(*LoginValidationRequest) (*LoginValidationResponse, error)

func (f IdentityProviderFunc) ValidateLogin(req *LoginValidationRequest) (*LoginValidationResponse, error) {
	return f(req)
}

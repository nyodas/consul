...
func (b *Builder) Build() (rt RuntimeConfig, err error) {
	...
	rt = RuntimeConfig{
		...
		SuspicionMaxBurst:                       b.intVal(c.SuspicionLimits.SuspicionMaxBurst),
		SuspicionRateEnforce:                    b.boolVal(c.SuspicionLimits.SuspicionRateEnforce),
		SuspicionRateLimit:                      rate.Limit(b.float64Val(c.SuspicionLimits.SuspicionRateLimit)),
